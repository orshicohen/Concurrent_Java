...
public abstract class Subscriber extends RunnableSubPub {
    private HashMap<Class<? extends Message>,Callback> Events_Callback;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
     Events_Callback.putIfAbsent(type,callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            Message s;
            try {
                s=MessageBrokerImpl.getInstance().awaitMessage(this);
                Events_Callback.get(s.getClass()).call(s);
